 ...
 */
package de.kimminich.agile.examples.lecture4;
        ...
        try {
            ...
            if (!sqlInjectionFoundForUrl && doExpressionBased && countExpressionBasedRequests < doExpressionMaxRequests) {
                ...
                try {
                    ...
                    if (this.debugEnabled)
                        log.debug("The parameter value [" + TestSQLInjection.getURLDecode(origParamValue) + "] is of type Integer");
                    ...
                    if (this.debugEnabled)
                        log.debug("The parameter value [" + TestSQLInjection.getURLDecode(origParamValue) + "] is NOT of type Integer");
